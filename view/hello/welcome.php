...
<code><a href="http://<?php echo $_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI']; ?>">http://<?php echo $_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI']; ?></a><br />
<a href="http://<?php echo $_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI']; ?>?format=xml">http://<?php echo $_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI']; ?></a></code>
...
<code><?php echo $this->link_to('home/view_all.json'); ?></code>
</pre>
